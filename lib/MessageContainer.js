...
export default class MessageContainer extends React.PureComponent {
    constructor(props) {
        ...
        this.renderRow = ({ item, index }) => {
            ...
            if (messages && user) {
                const previousMessage = (inverted || fakeInverted
                    ? messages[index + 1]
                    : messages[index - 1]) || {};
                const nextMessage = (inverted || fakeInverted
                    ? messages[index - 1]
                    : messages[index + 1]) || {};
                const messageProps = {
                    ...restProps,
                ...
                if (this.props.renderMessage) {
                    return (<View style={this.props.fakeInverted && styles.fakeInvert}>
        ...
        this.renderChatEmpty = () => {
            if (this.props.renderChatEmpty) {
                ...
                return this.props.inverted ? (empty) : (<View style={[
        ...
        this.renderHeaderWrapper = () => (<View style={[
    ...
    componentDidUpdate(prevProps) {
        ...
        const extraDataChange = this.props.extraData !== prevProps.extraData ||
    ...
    render() {
        ...
        const { inverted: removeInverted, ...invertibleScrollViewProps } = this.props.invertibleScrollViewProps;
        return (<View style={fakeInverted
        ...
        {this.state.showScrollBottom && this.props.scrollToBottom
            ...
            : null}
        <FlatList ref={this.getListRef} extraData={this.state.extraData} keyExtractor={this.keyExtractor} enableEmptySections automaticallyAdjustContentInsets={false} inverted={inverted} data={messages} style={[
            fakeInverted ? styles.fakeInvertListStyle : styles.listStyle,
            style,
        ]} contentContainerStyle={styles.contentContainerStyle} renderItem={this.renderRow} {...invertibleScrollViewProps} ListEmptyComponent={this.renderChatEmpty} ListFooterComponent={inverted || fakeInverted
            ? this.renderHeaderWrapper
            : this.renderFooter} ListHeaderComponent={inverted || fakeInverted
            ? this.renderFooter
            : this.renderHeaderWrapper} onScroll={this.handleOnScroll} scrollEventThrottle={100} onLayout={this.onLayoutList} onEndReached={this.onEndReached} onEndReachedThreshold={0.1} {...listViewProps}/>
      </View>);
    }
}
